...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "arbitrary-bytes.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "arbitrary-bytes.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'arbitrary_bytes'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'arbitrary_bytes':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_4a383efe1c6bfce741944de47150733c00c3fc48": function($0, $1, $2, $3) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);var h=($0);var framebuffer=($1);if(h.gl){var data=new Uint8Array(framebuffer.buffer,framebuffer.byteOffset,framebuffer.byteLength);h.gl.texSubImage2D(h.gl.TEXTURE_2D,0,0,0,($2),($3),h.gl.RGBA,h.gl.UNSIGNED_BYTE,data);h.gl.drawElements(h.gl.TRIANGLES,6,h.gl.UNSIGNED_SHORT,0);}else{h.buffer.set(framebuffer);h.ctx.putImageData(h.img,0,0);}
            },
            ...
            "__cargo_web_snippet_af56e25c105f7cb82386af7f7ac668e6cdcf73ad": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);if(soundHandler){soundHandler(($0));}
            },
        ...
        initialize: function( instance ) {
            ...
            Module.exports.update_bytes = function update_bytes(file_reader) {
    Module.instance.exports.update_bytes(Module.STDWEB_PRIVATE.prepare_any_arg(file_reader));
}
;
            __web_on_grow();
